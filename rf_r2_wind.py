...
df = pd.read_excel('Test/data/data.xlsx')
...
df["1/kelvin"] = 1/df["t_50m:C"]

# Kullanacağımız Veriler (Sorular)
features = [  't_50m:C', 'hour', "wind_dir_50m:d", "wind_speed_cubed", "pre_predict", 
...
# İndeksleri Sıfırla (Satır sildiğimiz için numaralar kaymasın diye 1, 5, 8... gitmesin)
...
feature_importance_df = pd.DataFrame({
    'Faktor': features,  # Senin kullandığın feature listesi
